...
namespace ArgedeSP.WebUI.Areas.Admin.Controllers
{
    ...
    public class CozumlerController : Controller
    {
        ...
        [HttpGet]
        public IActionResult Cozumler()
        {
            return View();
        }
        [HttpPost]
        public JsonResult CozumleriGetir()
        {
        ...
        [HttpPost]
        public async Task<JsonResult> CozumSil(int urunId)
        {
            if (urunId == 0)
            {
            ...
            switch (urunSil_OR.Message)
            {
                case MesajKodu.UrunBulunamadi:
                    sonuc.Mesaj = "Çözüm bulunamadı";
                    break;
                case MesajKodu.UrunSipariseEkli:
                    sonuc.Mesaj = "Çözüm siparişleri var, Silinemez";
                    break;
                default:
        ...
        [HttpGet]
        public async Task<IActionResult> CozumEkle()
        {
        ...
        [HttpPost]
        public async Task<IActionResult> CozumEkle([FromForm] UrunEkle_REQ urunEkle_REQ)
        {
            UrunEkle_RES urunEkle_RES = new UrunEkle_RES()
            {
            ...
            TempData["Basarili"] = "Çözüm Başarıyla Eklendi";
            return RedirectToAction("CozumDuzenle", new { urunId = ((Urun)urunEkle_OR.ReturnObject).Id });
        }
        [HttpGet]
        public async Task<IActionResult> CozumDuzenle(int urunId)
        {
            ...
            if (!urun_OR.IsSuccess || urun_OR.ReturnObject == null)
            {
                ...
                return RedirectToAction("Cozumler");
            }
        ...
        [HttpPost]
        public async Task<IActionResult> CozumDuzenle([FromForm] UrunEkle_REQ urunEkle_REQ)
        {
            ...
            if (!urunGuncelle_OR.IsSuccess)
            {
                ...
                {
                    case MesajKodu.UrunBulunamadi:
                        TempData["Hata"] = "Çözüm bulunamadı";
                        return RedirectToAction("Cozumler", "Cozumler");
                    case MesajKodu.UrunKategoriBulunamadı:
                        ModelState.AddModelError("UrunEkle_REQ.UrunKategoriId", "Kategori bulunamadı");
                        break;
                    case MesajKodu.SeoUrlZatenVar:
            ...
            return RedirectToAction("CozumDuzenle", new { urunId = urunEkle_REQ.Id });
        }
        [HttpGet]
        public IActionResult CozumKategorileri()
        {
            return View();
        }
        [HttpPost]
        public JsonResult CozumKategorileriGetir()
        {
            var dict = Request.Form.ToDictionary(x => x.Key, x => x.Value.ToString());
        ...
        [HttpGet]
        public IActionResult CozumKategorisiEkle()
        {
        ...
        [HttpPost]
        public async Task<IActionResult> CozumKategorisiEkle([FromForm] UrunKategoriEkle_REQ urunKategoriEkle_REQ)
        {
            if (!ModelState.IsValid)
            {
                return View(new UrunKategoriEkle_RES()
            ...
            if (urunKategoriEkle_OR.IsSuccess)
            {
                ...
                return RedirectToAction("CozumKategorisiEkle");
            }
        ...
        [HttpPost]
        public async Task<JsonResult> CozumKategoriSil(int kategoriId)
        {
            if (kategoriId == 0)
            {
                return Json(new Genel_RES()
        ...
        [HttpGet]
        public async Task<IActionResult> CozumKategoriDuzenle(int kategoriId)
        {
            if (kategoriId == 0)
            {
                TempData["Hata"] = "Kategori bulunamadi";
                return RedirectToAction("CozumKategorileri");
            }
        ...
        [HttpPost]
        public async Task<IActionResult> CozumKategoriDuzenle([FromForm] UrunKategoriEkle_REQ urunKategoriEkle_REQ)
        {
            if (!ModelState.IsValid)
            {
                return View(new UrunKategoriEkle_RES()
            ...
            if (urunKategoriEkle_OR.IsSuccess)
            {
                ...
                return RedirectToAction("CozumKategoriDuzenle", new { kategoriId = urunKategoriEkle_REQ.Id });
            }
        ...
        [HttpPost]
        public JsonResult CozumDilKategorileri(int dil)
        {
