...
namespace ArgedeSP.WebUI.Controllers
{
    public class UrunlerController : Controller
    {
        ...
        public UrunlerController(IUrunBS urunBS, IUrunKategoriBS urunKategoriBS, ISliderResimBS sliderResimBS, IAnahtarDegerBS anahtarDegerBS)
        {
            _urunBS = urunBS;
        ...
        public async Task<IActionResult> UrunDetay(string urunSeoUrl)
        {
        ...
        private List<UrunKategori> GetOncekiKategoriler(UrunDetayViewModel model)
        {
        ...
        public async Task<IActionResult> Urunler(string anaKategoriAdi = "", string altKategoriAdi = "", string filtre = "")
        {
