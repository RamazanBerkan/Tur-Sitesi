...
namespace ArgedeSP.WebUI.Controllers
{
    public class CozumlerController : Controller
    {
        ...
        public CozumlerController(IUrunBS urunBS, IUrunKategoriBS urunKategoriBS, ISliderResimBS sliderResimBS, IAnahtarDegerBS anahtarDegerBS)
        {
            _urunBS = urunBS;
        ...
        public async Task<IActionResult> CozumDetay(string urunSeoUrl)
        {
            ...
            CozumDetayViewModel urunDetayViewModel = new CozumDetayViewModel()
            {
            ...
            ViewBag.Kategoriler = GetOncekiKategoriler(urunDetayViewModel);
        ...
        private List<UrunKategori> GetOncekiKategoriler(CozumDetayViewModel model)
        {
        ...
        public async Task<IActionResult> Cozumler(string anaKategoriAdi = "", string altKategoriAdi = "", string filtre = "")
        {
            ...
            CozumViewModel urunViewModel = new CozumViewModel();
